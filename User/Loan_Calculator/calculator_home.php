...
<head>
  ...
  <link rel="stylesheet" href="calculator_home.css">
</head>
<body>
  <form action="calculator_home.php" method="post">
    <label class="label">Home Loan Calculator</label><br>
  ...
  <button class="exit-button" onclick="window.location.href='../../bank.php'">Exit</button>
</body>
</html>
