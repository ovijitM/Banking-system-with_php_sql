...
// Check if account number and password are provided
if (isset($_POST['account_number']) && isset($_POST['password'])) {
    $accountNumber = $_POST['account_number'];
    $password = $_POST['password'];

    // check if account number and password are valid
    ...
    echo "<p class='error'>Please enter your account number and password.</p>";
}
